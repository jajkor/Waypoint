...
import android.opengl.GLES30.GL_FALSE
...
class Program private constructor(
    ...
    fun setMat4(uniformName: String, m4: FloatArray, transpose: Boolean = true) =
        glUniformMatrix4fv(getUniformLocation(uniformName), 1, transpose, m4, 0)
