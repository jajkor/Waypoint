...
class MyGLRenderer(private val context: Context, private val camera: Camera3D) : GLSurfaceView.Renderer {
    private var campusModel: ObjModel? = null
    private var pathModel: ObjModel? = null
    private var cubeModel: ObjModel? = null
    private var gridQuad: ObjModel? = null
    ...
    override fun onSurfaceCreated(unused: GL10, config: EGLConfig) {
        ...
        cubeModel = ModelLoader(context).loadModel("cube/cube.obj", "cube/cube.obj")
    }
